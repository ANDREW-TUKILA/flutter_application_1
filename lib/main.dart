...
class CardsPlaing {
  ...
  CardsPlaing(this.imgPath, this.cardName, this.cardlabel, this.numberCard,
      this.rangCard, this.rangTrumpCard, this.brabeRang, this.brabeTrumpRang);
  //  {
  //    return
  //  };
  ...
  String get getCardlabel {
    return cardlabel;
  }

  String toStrting() {
    return '{${this.imgPath}, ${this.cardName}, ${this.cardlabel}, ${this.numberCard}, ${this.rangCard}}';
  }
}
...
class CardsStack {
  ...
  /*  var cardOne = CardsPlaing(
      imgPath: 'assets/play_cards/7_s.png',
      cardName: 'СЕМЁРКА',
      cardlabel: 'ПИКА'); */

  CardsStack() {
    cards.add(CardsPlaing(
        'assets/play_cards/7_s.png', 'СЕМЁРКА', 'ПИКА', 1, 0, 0, 1, 1));
    cards.add(CardsPlaing(
        'assets/play_cards/8_s.png', 'ВОСЬМЁРКА', 'ПИКА', 2, 0, 0, 2, 2));
    cards.add(CardsPlaing(
        'assets/play_cards/9_s.png', 'ДЕВЯТКА', 'ПИКА', 3, 0, 14, 3, 7));
    cards.add(CardsPlaing(
        'assets/play_cards/10_s.png', 'ДЕСЯТКА', 'ПИКА', 4, 10, 10, 7, 5));
    cards.add(CardsPlaing(
        'assets/play_cards/J_s.png', 'ВАЛЕТ', 'ПИКА', 5, 2, 20, 4, 8));
    cards.add(CardsPlaing(
        'assets/play_cards/Q_s.png', 'ДАМА', 'ПИКА', 6, 3, 3, 5, 3));
    cards.add(CardsPlaing(
        'assets/play_cards/K_s.png', 'КАРОЛЬ', 'ПИКА', 7, 4, 4, 6, 4));
    cards.add(CardsPlaing(
        'assets/play_cards/A_s.png', 'ТУЗ', 'ПИКА', 8, 11, 11, 8, 6));
    cards.add(CardsPlaing(
        'assets/play_cards/7_d.png', 'СЕМЁРКА', 'БУБНА', 9, 0, 0, 1, 1));
    cards.add(CardsPlaing(
        'assets/play_cards/8_d.png', 'ВОСЬМЁРКА', 'БУБНА', 10, 0, 0, 2, 2));
    cards.add(CardsPlaing(
        'assets/play_cards/9_d.png', 'ДЕВЯТКА', 'БУБНА', 11, 0, 14, 3, 7));
    cards.add(CardsPlaing(
        'assets/play_cards/10_d.png', 'ДЕСЯТКА', 'БУБНА', 12, 10, 10, 7, 5));
    cards.add(CardsPlaing(
        'assets/play_cards/J_d.png', 'ВАЛЕТ', 'БУБНА', 13, 2, 20, 4, 8));
    cards.add(CardsPlaing(
        'assets/play_cards/Q_d.png', 'ДАМА', 'БУБНА', 14, 3, 3, 5, 3));
    cards.add(CardsPlaing(
        'assets/play_cards/K_d.png', 'КАРОЛЬ', 'БУБНА', 15, 4, 4, 6, 4));
    cards.add(CardsPlaing(
        'assets/play_cards/A_d.png', 'ТУЗ', 'БУБНА', 16, 11, 11, 8, 6));
    cards.add(CardsPlaing(
        'assets/play_cards/7_h.png', 'СЕМЁРКА', 'ЧИРВА', 17, 0, 0, 1, 1));
    cards.add(CardsPlaing(
        'assets/play_cards/8_h.png', 'ВОСЬМЁРКА', 'ЧИРВА', 18, 0, 0, 2, 2));
    cards.add(CardsPlaing(
        'assets/play_cards/9_h.png', 'ДЕВЯТКА', 'ЧИРВА', 19, 0, 14, 3, 7));
    cards.add(CardsPlaing(
        'assets/play_cards/10_h.png', 'ДЕСЯТКА', 'ЧИРВА', 20, 10, 10, 7, 5));
    cards.add(CardsPlaing(
        'assets/play_cards/J_h.png', 'ВАЛЕТ', 'ЧИРВА', 21, 2, 20, 4, 8));
    cards.add(CardsPlaing(
        'assets/play_cards/Q_h.png', 'ДАМА', 'ЧИРВА', 22, 3, 3, 5, 3));
    cards.add(CardsPlaing(
        'assets/play_cards/K_h.png', 'КАРОЛЬ', 'ЧИРВА', 23, 4, 4, 6, 4));
    cards.add(CardsPlaing(
        'assets/play_cards/A_h.png', 'ТУЗ', 'ЧИРВА', 24, 11, 11, 8, 6));
    cards.add(CardsPlaing(
        'assets/play_cards/7_c.png', 'СЕМЁРКА', 'КРЕСТА', 25, 0, 0, 1, 1));
    cards.add(CardsPlaing(
        'assets/play_cards/8_c.png', 'ВОСЬМЁРКА', 'КРЕСТА', 26, 0, 0, 2, 2));
    cards.add(CardsPlaing(
        'assets/play_cards/9_c.png', 'ДЕВЯТКА', 'КРЕСТА', 27, 0, 14, 3, 7));
    cards.add(CardsPlaing(
        'assets/play_cards/10_c.png', 'ДЕСЯТКА', 'КРЕСТА', 28, 10, 10, 7, 5));
    cards.add(CardsPlaing(
        'assets/play_cards/J_c.png', 'ВАЛЕТ', 'КРЕСТА', 29, 2, 20, 4, 8));
    cards.add(CardsPlaing(
        'assets/play_cards/Q_c.png', 'ДАМА', 'КРЕСТА', 30, 3, 3, 5, 3));
    cards.add(CardsPlaing(
        'assets/play_cards/K_c.png', 'КАРОЛЬ', 'КРЕСТА', 31, 4, 4, 6, 4));
    cards.add(CardsPlaing(
        'assets/play_cards/A_c.png', 'ТУЗ', 'КРЕСТА', 32, 11, 11, 8, 6));

    // cards.shuffle();  // random place cards in stack
  }
  List<CardsPlaing> get getCards {
    return cards;
  }
}

/* void shuffleCards(cards, [int start = 0, int end]) {
  var random = Random();
  end = cards.cards.length;
  var length = end - start;
  while (length > 1) {
    var pos = random.nextInt(length);
    length--;
    var tmp1 = cards.cards[start + pos];
    cards.cards[start + pos] = cards.cards[start + length];
    cards.cards[start + length] = tmp1;
  }
} */
...
class MyHomePageState extends State<MyHomePage> {
  ...
  CardsPlaing firstPutCard = CardsPlaing('assets/icecrown_card.png', 'РУБАШКА',
      'ПИКА', 1, 0, 0, 0, 0); // карта положенная игроком чей сейчас ход

  CardsPlaing cardOfPlayer1 = new CardsPlaing(
      'assets/icecrown_card.png', 'РУБАШКА', 'ПИКА', 1, 0, 0, 0, 0);
  CardsPlaing cardOfPlayer2 = new CardsPlaing(
      'assets/icecrown_card.png', 'РУБАШКА', 'ПИКА', 1, 0, 0, 0, 0);
  CardsPlaing cardOfPlayer3 = new CardsPlaing(
      'assets/icecrown_card.png', 'РУБАШКА', 'ПИКА', 1, 0, 0, 0, 0);

  bool isSuccessful = true;
  CardsPlaing cardOfPlayer4 = new CardsPlaing(
      'assets/icecrown_card.png', 'РУБАШКА', 'ПИКА', 1, 0, 0, 0, 0);
            ...
            child: Builder(builder: (BuildContext context) {
              ...
              return Stack(
                ...
                children: <Widget>[
                  ...
                  ScoreboardWidget(scoresForRoundFirstTeam,scoresForRoundSecondTeam),
                  AnalisisScore(cardOfPlayer1,cardOfPlayer2,cardOfPlayer3,cardOfPlayer4, trump, quantityCard),
                  // Positioned(
                  //     // top: 0,
                  //     bottom: -130,
                  //     // left: -50,
  ...
  Positioned moveCardPlayer2(CardsPlaing cardPlaing,CardsPlaing cardPlayerBefore) {
    if (cardPlayerBefore.imgPath != 'assets/icecrown_card.png') {
      cardOfPlayer2 =
  ...
  Positioned moveCardPlayer3(CardsPlaing cardPlaing,CardsPlaing cardPlayerBefore) {
    if (cardPlayerBefore.imgPath != 'assets/icecrown_card.png') {
      cardOfPlayer3 =
